...
class MenuSeeder extends Seeder
{
    ...
    */
    ...
    { 
        ...
        $this->insertTitle('admin','MASTER');
        $this->beginDropdown('admin', 'Widget', 'cil-view-module');
            $this->insertLink('admin', 'Slider',     '/slider');
            $this->insertLink('admin', 'About',      '/about');
            $this->insertLink('admin', 'Layanan',    '/service');
            $this->insertLink('admin', 'Sponsor',    '/sponsor');
            $this->insertLink('admin','Galeri',      '/gallery');
        $this->endDropdown();
